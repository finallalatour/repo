...
<!-- 회원가입 폼 -->
<div class ="tb_Head01" >
<form action="joinaf.do" method="post" onsubmit="return check()">
...
<tr>
	...
	<td>
		<select name="question">
			<c:forEach items="${qlist}" var="que" varStatus="i">
...
<tr>
	<th>질문 답변</th>
	<td>
		<input type="text" name="answer" id="_answer" size="20">
	</td>
</tr>
<tr>
   <th>주소</th>
...
<div align="center">
   ...
   <button type="submit" id="submitBtn" class="btn btn-primary btn-sm" disabled="disabled">회원가입</button>
</div>
